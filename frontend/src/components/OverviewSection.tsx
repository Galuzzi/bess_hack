export const OverviewSection = () => {
    const grafanaIframes = [
        ...
        },
        {
            ...
            src: "http://localhost:3000/d-solo/a1ce40a4-3e62-4939-a48c-1343d0083aa1/security-and-incident-management?orgId=1&from=1749856200000&to=1749858900000&timezone=browser&var-datasource=aexz24qqeaoe8e&refresh=10s&showCategory=Value%20mappings&tab=queries&theme=light&panelId=10&__feature.dashboardSceneSolo=true",
            height: "100%",
            with: "100%"
        },
        {
        ...
        },
        {
            id: "voltage",
            title: "Voltage",
            src: "http://localhost:3000/d-solo/a1ce40a4-3e62-4939-a48c-1343d0083aa1/security-and-incident-management?orgId=1&from=1749856200000&to=1749858900000&timezone=browser&var-datasource=aexz24qqeaoe8e&refresh=10s&showCategory=Value%20mappings&theme=light&panelId=9&__feature.dashboardSceneSolo=true",
            height: "100%",
            with: "100%"
        }
    ];
